# Generated by Powerlevel10k configuration wizard on 2020-05-09 at 11:10 -03.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 05033.
# Wizard options: nerdfont-complete + powerline, large icons, lean, time, 2 lines,
# dotted, no frame, dark, sparse, few icons, concise, instant_prompt=verbose.
